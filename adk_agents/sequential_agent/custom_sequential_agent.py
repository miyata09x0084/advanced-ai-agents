...
# Session and Runner
# Define and manage session information
...
async def main():
    ...
    # Create runner to trigger an invocation of the agent
    runner = Runner(agent=root_agent, app_name=APP_NAME, session_service=session_service)

    await call_agent(runner, "perform math addition")

    # you can run more queries here
    # await call_agent("perform math subtraction")
    # await call_agent("perform math multiplication")
    # await call_agent("perform math division")x

# First Agent Interaction
async def call_agent(runner, query):

    # preparing content to pass to agent
...
if __name__ == "__main__":
    print("Running custom agent interaction...")
    asyncio.run(main())
    print("Custom agent interaction completed.")
